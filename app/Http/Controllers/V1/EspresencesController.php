...
class EspresencesController extends Controller
{
    /**
    ...
    public function __construct(IEspresencesRepository $repository, CustomValidator $validator, JsonCustomResponse $response)
    {
